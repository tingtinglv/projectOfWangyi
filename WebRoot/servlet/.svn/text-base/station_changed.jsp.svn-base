...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	...
	<body>
		...
		<div class="query">
				<form name="staff_add" action="PostchFindServlet.action">
  ...
  <div class="pagination pagination-centered pagination-small">
		...
		<%
              ...
              {
               %>
			   <li><a href="PostchFindServlet.action?currentPage=${page.currentPage -1}">上一页</a></li>
               <%
               }
               if(mypage.getTotalPage()<=7)
               {
               		...
               		{
               	%>
               <li><a href="PostchFindServlet.action?currentPage=<%=i%>" id=<%=i %>><%=i %></a></li>
               	<%
               		}
               }
               else
               {
               		...
               		%>
               		<li><a href="#">...</a></li>
               		 <li><a href="PostchFindServlet.action?currentPage=${page.totalPage}">末页</a></li>
               		<%
               		}
               		else if((mypage.getTotalPage()-mypage.getCurrentPage())<=3)
               		{
               		%>
               		 <li><a href="PostchFindServlet.action?currentPage=1 ">首页</a></li>
               		<li><a href="#">...</a></li>
               		<%
              ...
              {
               %>
                <li><a href="PostchFindServlet.action?currentPage=${page.currentPage +1}  ">下一页</a></li>
               <%
               }
                %>
		</ul>
